...
func TestExtractJTI(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			jwt:     "",
			wantJTI: "",
			wantErr: nil, // Will contain "DPoP JWT is empty"
		},
		{
			name:    "invalid JWT format",
			jwt:     "not.a.jwt",
			wantJTI: "",
			wantErr: nil, // Will contain "failed to parse JWT"
		},
		{
			name:    "valid JWT with JTI",
			jwt:     "eyJhbGciOiJFUzI1NiIsInR5cCI6ImRwb3Arand0IiwiandrIjp7Imt0eSI6IkVDIiwiY3J2IjoiUC0yNTYiLCJ4IjoiQVlFSWpKU29UeHFJY3pNYzRHLXE4dXhCRXJhLWtNX0pSUjNhczZWYWV3QSIsInkiOiJVc0pxLWh1TnRyNzB1VFVPRkJWd0dUUHpzcGwyd1J2OGxweXg5TU1LZG9ZIn19.eyJqdGkiOiI4NGJiMzI2NmNjZDZhYmY4IiwiaHRtIjoiUE9TVCIsImh0dSI6Imh0dHBzOi8vaXNzdWVyLmV4YW1wbGUuY29tL3Rva2VuIiwiaWF0IjoxNzQ4MzM1NTU0fQ.invalid",
			wantJTI: "84bb3266ccd6abf8",
			wantErr: nil,
		},
		{
			name:    "JWT without JTI",
			jwt:     "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIn0.invalid",
			wantJTI: "",
			wantErr: ErrMissingJTI,
		},
		{
			name:    "JWT with short JTI",
			jwt:     "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJzaG9ydCJ9.invalid",
			wantJTI: "",
			wantErr: ErrInvalidJTI,
		},
	}
