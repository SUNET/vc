...
func TestCredentialOfferURIQR(t *testing.T) {
	...
	for _, tt := range tts {
		t.Run(tt.name, func(t *testing.T) {
			p, err := tt.parameters.CredentialOfferURI(uuid.NewString())
			assert.NoError(t, err)
...
func TestCredentialOfferURI(t *testing.T) {
	...
	for _, tt := range tts {
		t.Run(tt.name, func(t *testing.T) {
			got, err := tt.parameters.CredentialOfferURI(uuid.NewString())
			assert.NoError(t, err)
...
func TestCredentialOfferUriUUID(t *testing.T) {
	...
	for _, tt := range tts {
		t.Run(tt.name, func(t *testing.T) {
			uri, err := tt.have.CredentialOfferURI(uuid.NewString())
			assert.NoError(t, err)
