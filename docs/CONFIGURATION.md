...
| `format`             | `string` | Verifier_info format identifier advertised alongside the certificate. Defaults to "rc-wrp+jwt"; override only for an ecosystem that has profiled a different identifier for the same document.                                                                                                                                                                               | `"rc-wrp+jwt"`                           | -       | No       |
