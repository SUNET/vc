...
| `claims`        | `string`   | JSON string conforming to OIDC Core §5.5 claims request parameter. Supports Go template syntax for dynamic values: "{{.variable_name}}"                         | `"{\"id_token\":{\"org_id\":{\"value\":\"{{.org_id}}\"}}}"` | -       | No       |
