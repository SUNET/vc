    ...
    "definitions": {
        ...
        "openid4vci.TokenRequest": {
            ...
            "properties": {
                ...
                "grant_type": {
                    "description": "GrantType REQUIRED. \"authorization_code\", \"urn:ietf:params:oauth:grant-type:pre-authorized_code\", or \"refresh_token\".",
                    "type": "string",
                    "enum": [
                        "authorization_code",
                ...
                "refresh_token": {
                    "description": "RefreshToken REQUIRED for refresh_token grant. The refresh token previously issued to the client.",
                    "type": "string",
                    "maxLength": 256
                },
                "tx_code": {
        ...
        "openid4vci.TokenResponse": {
            ...
            "properties": {
                ...
                "refresh_token": {
                    "description": "RefreshToken OPTIONAL. A refresh token bound to the DPoP key, allowing the client to obtain\nfresh access tokens for credential re-issuance without full re-authentication.",
                    "type": "string"
                },
                "refresh_token_expires_in": {
                    "description": "RefreshTokenExpiresIn OPTIONAL. Lifetime in seconds of the refresh token.",
                    "type": "integer"
                },
                "scope": {
